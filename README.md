...
Outside of academics, I participate in several tech-focused clubs and enjoy making connections with other students and developers.
...
- Leaderboard systems  
- API integration  
- Stack, Map, and Set data structures  
- Recursive utilities  
- Modular OOP architecture

**Key Skills Gained:**  
Debugging, testing, version control, and deploying a multi-feature application.
...
- Vector math for ball physics  
- Randomization logic  
- Event-driven input handling

**Key Skills Gained:**  
Experience with C++, OOP design, debugging, and graphics programming.
